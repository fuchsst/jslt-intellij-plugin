...
public class JsltMatcherMinusImpl extends ASTWrapperPsiElement implements JsltMatcherMinus {

  public JsltMatcherMinusImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JsltVisitor visitor) {
    visitor.visitMatcherMinus(this);
  }
