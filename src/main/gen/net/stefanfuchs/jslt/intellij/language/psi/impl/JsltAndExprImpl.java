...
public class JsltAndExprImpl extends ASTWrapperPsiElement implements JsltAndExpr {

  public JsltAndExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public JsltAndExpr getAndExpr() {
    return findChildByClass(JsltAndExpr.class);
  }

  @Override
  @NotNull
  public JsltComparativeExpr getComparativeExpr() {
    return findNotNullChildByClass(JsltComparativeExpr.class);
  }
