...
public class JsltAdditiveOperatorImpl extends ASTWrapperPsiElement implements JsltAdditiveOperator {

  public JsltAdditiveOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
