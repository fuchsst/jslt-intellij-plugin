...
public class JsltArraySlicingImpl extends ASTWrapperPsiElement implements JsltArraySlicing {

  public JsltArraySlicingImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JsltVisitor visitor) {
    visitor.visitArraySlicing(this);
  }
