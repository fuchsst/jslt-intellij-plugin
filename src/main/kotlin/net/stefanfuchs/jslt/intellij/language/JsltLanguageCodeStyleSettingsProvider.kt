        ...
        when (settingsType) {
            SettingsType.SPACING_SETTINGS -> {
                consumer.showStandardOptions(
                    ...
                    CodeStyleSettingsCustomizable.SpacingOption.SPACE_AFTER_COMMA_IN_TYPE_ARGUMENTS.name,
                    ...
                    CodeStyleSettingsCustomizable.SpacingOption.SPACE_WITHIN_METHOD_CALL_PARENTHESES.name,
                    CodeStyleSettingsCustomizable.SpacingOption.SPACE_WITHIN_METHOD_PARENTHESES.name,
                    CodeStyleSettingsCustomizable.SpacingOption.SPACE_WITHIN_IF_PARENTHESES.name,
                    CodeStyleSettingsCustomizable.SpacingOption.SPACE_WITHIN_FOR_PARENTHESES.name,
                ...
                consumer.renameStandardOption(CodeStyleSettingsCustomizable.SpacingOption.SPACE_AROUND_ASSIGNMENT_OPERATORS.name, "Assignment operators (':', '=')")
                consumer.renameStandardOption(CodeStyleSettingsCustomizable.SpacingOption.SPACE_WITHIN_METHOD_CALL_PARENTHESES.name, "Function call parenthesis")
                consumer.renameStandardOption(CodeStyleSettingsCustomizable.SpacingOption.SPACE_WITHIN_METHOD_PARENTHESES.name, "Function declaration parenthesis")
                consumer.renameStandardOption(CodeStyleSettingsCustomizable.SpacingOption.SPACE_WITHIN_EMPTY_METHOD_CALL_PARENTHESES.name, "Empty function call parenthesis")
                consumer.renameStandardOption(CodeStyleSettingsCustomizable.SpacingOption.SPACE_BEFORE_METHOD_CALL_PARENTHESES.name, "Function call parenthesis")
                consumer.renameStandardOption(CodeStyleSettingsCustomizable.SpacingOption.SPACE_WITHIN_BRACKETS.name, "Array brackets")
                consumer.renameStandardOption(CodeStyleSettingsCustomizable.SpacingOption.SPACE_WITHIN_BRACES.name, "Object braces")
            ...
            SettingsType.WRAPPING_AND_BRACES_SETTINGS -> {
                consumer.showStandardOptions(
                    ...
                    CodeStyleSettingsCustomizable.WrappingOrBraceOption.ALIGN_MULTILINE_BINARY_OPERATION.name,
                    CodeStyleSettingsCustomizable.WrappingOrBraceOption.ALIGN_MULTILINE_FOR.name,
                    CodeStyleSettingsCustomizable.WrappingOrBraceOption.ALIGN_MULTILINE_METHOD_BRACKETS.name,
                    ...
                    CodeStyleSettingsCustomizable.WrappingOrBraceOption.BINARY_OPERATION_SIGN_ON_NEXT_LINE.name,
                    CodeStyleSettingsCustomizable.WrappingOrBraceOption.BINARY_OPERATION_WRAP.name,
                    ...
                    CodeStyleSettingsCustomizable.WrappingOrBraceOption.DO_NOT_INDENT_TOP_LEVEL_CLASS_MEMBERS.name,
                    CodeStyleSettingsCustomizable.WrappingOrBraceOption.ELSE_ON_NEW_LINE.name,
                    CodeStyleSettingsCustomizable.WrappingOrBraceOption.FOR_STATEMENT_LPAREN_ON_NEXT_LINE.name,
                    CodeStyleSettingsCustomizable.WrappingOrBraceOption.FOR_STATEMENT_RPAREN_ON_NEXT_LINE.name,
                    CodeStyleSettingsCustomizable.WrappingOrBraceOption.FOR_STATEMENT_WRAP.name,
                    ...
                    CodeStyleSettingsCustomizable.WrappingOrBraceOption.METHOD_PARAMETERS_LPAREN_ON_NEXT_LINE.name,
                    CodeStyleSettingsCustomizable.WrappingOrBraceOption.METHOD_PARAMETERS_RPAREN_ON_NEXT_LINE.name,
                    CodeStyleSettingsCustomizable.WrappingOrBraceOption.METHOD_PARAMETERS_WRAP.name,
                    CodeStyleSettingsCustomizable.WrappingOrBraceOption.PARENTHESES_EXPRESSION_LPAREN_WRAP.name,
                    CodeStyleSettingsCustomizable.WrappingOrBraceOption.PARENTHESES_EXPRESSION_RPAREN_WRAP.name,
                    CodeStyleSettingsCustomizable.WrappingOrBraceOption.PLACE_ASSIGNMENT_SIGN_ON_NEXT_LINE.name,
                    CodeStyleSettingsCustomizable.WrappingOrBraceOption.PREFER_PARAMETERS_WRAP.name,
